...
/*
// count all the doors on the scene 
console.log("total num of walls on scene ", walls.size);

// door types const values  
console.log("CONST.WALL_DOOR_TYPES.DOOR ", CONST.WALL_DOOR_TYPES.DOOR);//1
console.log("CONST.WALL_DOOR_TYPES.SECRET ", CONST.WALL_DOOR_TYPES.SECRET);//2

// door states const values 
console.log("CONST.WALL_DOOR_STATES.OPEN ", CONST.WALL_DOOR_STATES.OPEN);//1
console.log("CONST.WALL_DOOR_STATES.CLOSED ", CONST.WALL_DOOR_STATES.CLOSED);//0

// count all open doors on the scene 
const walls_with_doors = walls.filter(wall => wall.door===CONST.WALL_DOOR_TYPES.DOOR);
console.log("num of doors on scene", walls_with_doors.length); // note length vs size
*/
